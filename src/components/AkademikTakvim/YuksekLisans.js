...
export default class YuksekLisans extends Component {
    constructor() {
        super();
        this.state = {
            yuksekLisans: [],
    ...
    componentDidMount() {
        ...
        this.setState({yuksekLisans: data, yuksekLisansBackup: data})
    }
    ...
    onFilter = (text) => {
        ...
        let updatedList = this.state.yuksekLisansBackup.filter(function(item) {
        ...
        return (
            <View style = {{flex: 1,  backgroundColor: '#efebeb',}}>
                ...
                <Timeline
                    ...
                    eventContainerStyle={{}}
                    options={{
                        initialNumToRender: this.state.yuksekLisans.length
                    }}
                />
