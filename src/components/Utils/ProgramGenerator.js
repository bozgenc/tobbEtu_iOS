        ...
        for (var j = 0; j < data.length; j++) {
            for (var k = 0; k < data[j].baslamaSaati.length; k++) {
                ...
                if (data[j].baslamaSaati[k].includes("Pazartesi") && data[j].baslamaSaati[k].includes("08.30")) {
                    ...
                    if (data[j].baslamaSaati[k].charAt(data[j].baslamaSaati[k].lastIndexOf(",") - 1) == 3) {
                        if (tablo[1][0] !== "") {
                            tablo[1][0] += " || "
                        }
                        tablo[1][0] += data[j].dersKodu + "\n";
                    ...
                    if (data[j].baslamaSaati[k].charAt(data[j].baslamaSaati[k].lastIndexOf(",") - 1) == 4) {
                        if (tablo[1][0] !== "") {
                            tablo[1][0] += " || "
                        }
                        tablo[1][0] += data[j].dersKodu + "\n";
                    ...
                    if (data[j].baslamaSaati[k].charAt(data[j].baslamaSaati[k].lastIndexOf(",") - 1) == 5) {
                        if (tablo[1][0] !== "") {
                            tablo[1][0] += " || "
                        }
                        tablo[1][0] += data[j].dersKodu + "\n";
                    ...
                    if (data[j].baslamaSaati[k].charAt(data[j].baslamaSaati[k].lastIndexOf(",") - 1) == 6) {
                        if (tablo[1][0] !== "") {
                            tablo[1][0] += " || "
                        }
                        tablo[1][0] += data[j].dersKodu + "\n";
